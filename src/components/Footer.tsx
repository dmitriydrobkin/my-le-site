          ...
          <div className="order-3 lg:col-span-3 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-2">
                ...
                <a href="https://wa.me/380958002580" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-green-500 transition-colors">
