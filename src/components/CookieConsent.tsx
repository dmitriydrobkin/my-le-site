...
export function CookieConsent({ lang }: { lang: string }) {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-[100] animate-in slide-in-from-bottom-5 fade-in duration-500">
      <div className="bg-white px-4 py-3 rounded-full shadow-lg border border-ink/5 flex items-center gap-3">
