...
export default function HomeClient({ content }: { content: any }) {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section 
        className="relative min-h-[100vh] h-full flex flex-col justify-center px-6 pt-24 pb-24 bg-cover bg-center"
        style={content?.heroImage ? { backgroundImage: `url(${content.heroImage})` } : {}}
      >
        <div className="absolute inset-0 bg-white/80 z-0" style={{ display: content?.heroImage ? 'block' : 'none' }} />
        
        <div className="relative z-10 max-w-[1400px] mx-auto w-full">
          <div className="max-w-4xl">
            <h1 className="font-display text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight text-ink leading-[1.05] mb-10 whitespace-pre-wrap">
              {content?.h1 || (
                <>
                  DIGITAL РЕШЕНИЯ
                  <br />
            ...
            <p className="font-sans text-xl text-ink/60 max-w-2xl font-medium leading-relaxed mb-12 whitespace-pre-wrap">
              {content?.heroSubtitle || 'Проектирую, разрабатываю и запускаю высококонверсионные веб-системы и Telegram-боты, которые работают на рост вашей прибыли 24/7.'}
            </p>
