...
export default function LandingsPage({ params }: { params: { lang: string } }) {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative min-h-[100vh] h-full flex flex-col justify-center px-6 max-w-[1400px] mx-auto pt-32 pb-16 lg:py-0 w-full">
        ...
        <div className="max-w-5xl relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            <Link href={`/${params.lang}/portfolio`} className="flex items-center gap-3 text-ink font-bold hover:text-coral transition-colors group">
      ...
      {/* 2. ЗАЧЕМ / ЧТО ВХОДИТ В СТОИМОСТЬ (WHY SECTION) */}
      ...
      <section className="py-12 lg:py-24 bg-white border-b border-ink/5 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6">
            {[
              { icon: <LayoutPanelLeft className="w-8 h-8 text-ink/40 group-hover:text-coral transition-colors" />, hoverColor: 'hover:border-coral/20' },
              { icon: <Zap className="w-8 h-8 text-ink/40 group-hover:text-cyan-500 transition-colors" />, hoverColor: 'hover:border-cyan-500/20' },
              { icon: <TelegramIcon className="w-8 h-8 text-ink/40 group-hover:text-blue-500 transition-colors" />, hoverColor: 'hover:border-blue-500/20' },
              ...
              <div key={idx} className={`bg-surface rounded-[2rem] p-6 lg:p-8 flex flex-col border border-ink/5 hover:shadow-xl ${item.hoverColor} transition-all duration-500 group mobile-hover-card`}>
      ...
      <section className="py-16 lg:py-20 bg-ink text-white relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10 flex flex-col xl:flex-row gap-12 lg:gap-16 xl:gap-24">
          <div className="xl:w-1/2">
            ...
            <h2 
              className="font-display text-[clamp(2.5rem,6vw,4.5rem)] font-bold tracking-tight leading-[1.05] mb-8 break-words"
      ...
      <section className="py-16 lg:py-24 bg-surface">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="bg-gradient-to-br from-surface to-white border border-ink/5 rounded-[3rem] p-8 lg:p-16 relative overflow-hidden shadow-2xl flex flex-col xl:flex-row items-center justify-between gap-12">
            ...
            <div className="relative z-10 max-w-2xl w-full">
              ...
              <QuizTrigger className="bg-coral hover:bg-coral/90 text-white rounded-full px-10 py-5 font-bold font-sans tracking-widest text-sm uppercase transition-all shadow-neon-coral hover:-translate-y-1 inline-flex items-center gap-4 group w-full sm:w-auto justify-center">
                {dict.ctaBtn}
                <ArrowUpRight className="w-5 h-5 group-hover:rotate-45 transition-transform" />
              </QuizTrigger>
            </div>
