  ...
  return (
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-[100vh] h-full flex flex-col justify-center px-6 max-w-[1400px] mx-auto pt-24 lg:pt-32 pb-16 lg:pb-24">
        <div className="absolute top-0 right-0 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-gradient-to-bl from-indigo-500/10 via-purple-500/5 to-transparent rounded-full blur-3xl pointer-events-none opacity-70 animate-float" />
        <div className="absolute bottom-0 left-0 w-[200px] h-[200px] md:w-[400px] md:h-[400px] bg-gradient-to-tr from-pink-500/10 via-rose-400/5 to-transparent rounded-full blur-3xl pointer-events-none opacity-60 animate-float" style={{ animationDelay: '2s' }} />
