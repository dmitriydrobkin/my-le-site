          ...
          <div className="flex flex-col md:flex-row gap-12 lg:gap-24">
            ...
            <div className="lg:w-1/3">
              ...
              <p className="font-sans text-ink/50 leading-relaxed font-medium">
                Здесь я создаю не просто страницы, а статус, абсолютное доверие ваших партнеров и прочный фундамент для органического роста.
              </p>
            </div>
      ...
      <section className="py-12 lg:py-24 bg-surface border-b border-ink/5 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Card 1 */}
            <div className="bg-white rounded-[2rem] p-8 lg:p-10 flex flex-col border border-ink/5 hover:shadow-xl hover:border-indigo-500/20 transition-all duration-500 group mobile-hover-card">
            ...
            {/* Card 2 */}
            <div className="bg-white rounded-[2rem] p-8 lg:p-10 flex flex-col border border-ink/5 hover:shadow-xl hover:border-purple-500/20 transition-all duration-500 group mobile-hover-card">
              <div className="w-16 h-16 rounded-full bg-surface border border-ink/5 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
