  ...
  return (
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-[100vh] h-full flex flex-col justify-center px-6 max-w-[1400px] mx-auto pt-32 pb-16 lg:py-0">
        <div className="absolute top-0 right-0 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-gradient-to-bl from-rose-500/10 via-pink-400/5 to-transparent rounded-full blur-3xl pointer-events-none opacity-70" />
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16">
            ...
            <p className="font-sans text-ink/50 leading-relaxed font-medium max-w-sm">
              Минимум воды, максимум пользы. Я упаковываю вашу экспертность в стильный цифровой продукт.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-[2rem] p-8 lg:p-10 flex flex-col border border-ink/5 hover:shadow-xl hover:border-emerald-500/20 transition-all duration-500 group mobile-hover-card">
              ...
              <p className="font-sans text-sm text-ink/60 font-medium leading-relaxed mt-auto">
                Блок «Обо мне/О компании», в котором я четко раскрываю ваш опыт, ценности и ключевые преимущества для клиента.
              </p>
            </div>
