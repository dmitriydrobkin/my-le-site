        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-surface rounded-[2rem] p-6 lg:p-8 flex flex-col border border-ink/5 hover:shadow-xl hover:border-emerald-500/20 transition-all duration-500 group mobile-hover-card">
