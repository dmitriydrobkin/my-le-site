...
const uk: Dictionary = {
  ...
  about: {
    badge: 'Про мене',
    title: 'Привіт, <br/>я Дмитро <span class="text-coral">👋</span>',
  ...
  finalCta: {
    title: 'Давайте поговоримо <br class="hidden md:block" /> про ваш проєкт',
...
const ru: Dictionary = {
  ...
  about: {
    badge: 'Обо мне',
    title: 'Привет, <br/>я Дмитрий <span class="text-coral">👋</span>',
  ...
  finalCta: {
    title: 'Давайте поговорим <br class="hidden md:block" /> о вашем проекте',
